...
\vspace{-0.1cm}
\begin{itemize} \itemsep-0.2cm
\item[$\cdot$] Bringing Sprout (plastic) and Air 2 (IoT) products from design to production\\
\item[$\cdot$] Improving previous products based on feedback from customer service and sales teams.\\
\end{itemize}
...
Bachelor of Medical Science 2014 & Computational Biochemistry, University of Western Ontario\\ [1ex]
